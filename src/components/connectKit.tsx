...
import { mainnet, optimism, optimismSepolia } from '@particle-network/connectkit/chains';
...
const config = createConfig({
    ...
    appearance: {
        ...
        logo: 'https://raw.githubusercontent.com/AtmegaBuzz/dashboard/refs/heads/main/src/assets/project.png',
    ...
    walletConnectors: [
        evmWalletConnectors({
            metadata: { name: 'P3 AI Identity', icon: 'https://raw.githubusercontent.com/AtmegaBuzz/dashboard/refs/heads/main/src/assets/project.png', description: '', url: '' }, // Optional, this is Metadata used by WalletConnect and Coinbase
